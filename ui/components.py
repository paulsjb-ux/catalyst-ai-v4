...
def top_navigation() -> str:
    return st.radio("Navigation", ["Dashboard", "Daily Brief", "Market Scan", "Trade Universe", "Watchlist", "Validation", "Repeat Winners", "Reports", "Settings"], horizontal=True, label_visibility="collapsed", key="primary_navigation")
