...
def top_navigation() -> str:
    return st.radio("Navigation", ["Daily Routine", "Dashboard", "Daily Brief", "Alerts", "Market Scan", "Paper Trading", "Trade Universe", "Watchlist", "Validation", "Repeat Winners", "Reports", "Settings"], horizontal=True, label_visibility="collapsed", key="primary_navigation")
