...
def render_dashboard(version: str, scan_results: pd.DataFrame | None = None) -> None:
    section_header("Command Dashboard", "Live intelligence, market regime, saved scan status and smarter scoring.")
    ...
    c4.markdown(metric_card("Avg Score", str(avg_score), "regime-adjusted score"), unsafe_allow_html=True)

    st.markdown("### System Status")
    status_card("Sprint 2 Part 4 market regime awareness is installed.", "positive")
