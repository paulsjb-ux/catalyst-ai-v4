...
def render_market_scan() -> None:
    ...
    buys = int((frame["signal"] == "BUY").sum())
    watches = int((frame["signal"] == "WATCH").sum())
    ...
    if filtered.empty:
        ...
        st.dataframe(
            filtered[["ticker","signal","score","close","change_1d_pct","change_20d_pct","rsi_14","volume_ratio","trend","reason"]],
