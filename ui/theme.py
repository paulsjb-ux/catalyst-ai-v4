...
def apply_theme() -> None:
    ...
    .hero{
        ...
        border:1px solid #bfdbfe;border-radius:28px;padding:24px;
        box-shadow:0 18px 42px rgba(15,23,42,.08);margin-bottom:18px;
    }
    ...
    div[data-testid="stRadio"]{
        ...
        border:1px solid #dbeafe;border-radius:20px;padding:8px;margin-bottom:1rem;
        box-shadow:0 12px 28px rgba(15,23,42,.08);overflow-x:auto;
    }
    ...
    .stTextArea textarea,.stTextInput input,div[data-baseweb="select"]>div{
        background:#fff!important;color:#0f172a!important;border:1px solid #bfdbfe!important;
        border-radius:14px!important;box-shadow:0 8px 20px rgba(15,23,42,.05)
    }
    ...
    .stButton button,.stDownloadButton button{
        ...
        min-height:48px;font-weight:900!important;box-shadow:0 12px 28px rgba(37,99,235,.20)
    }
